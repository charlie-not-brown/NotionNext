...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '提摩西漫画小屋', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '审鸭积累中', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://timdrake.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '提姆德雷克,红罗宾,美漫,DC,阅读顺序', // 网站关键词 英文逗号隔开
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: ['https://cdn.jsdelivr.net/gh/IdreesInc/Pocket-Bird@main/dist/web/birb.embed.js'], // e.g. ['http://xx.com/script.js','http://xx.com/script.js']
